...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    window.addEventListener("popstate", function (eventListener) {
        if (eventListener.state !== null) {
            contentDiv.scrollTop = eventListener.state;
        }
    });
    window.addEventListener("hashchange", function (eventListener) {
        history.replaceState(contentDiv.scrollTop, document.title);
    });
    contentDiv.addEventListener("scroll", function (eventListener) {
        let timeoutID;
        if (!timeoutID) {
